# `Git_jll.jl` (v2.54.0+0)

[![deps](https://juliahub.com/docs/Git_jll/deps.svg)](https://juliahub.com/ui/Packages/General/Git_jll/)

This is an autogenerated package constructed using [`BinaryBuilder.jl`](https://github.com/JuliaPackaging/BinaryBuilder.jl).

The originating [`build_tarballs.jl`](https://github.com/JuliaPackaging/Yggdrasil/blob/ed78ea5b6683f7c6b6fca4bc89bb3571038a9593/G/Git/build_tarballs.jl) script can be found on [`Yggdrasil`](https://github.com/JuliaPackaging/Yggdrasil/), the community build tree.
...
* compressed archive: https://mirrors.edge.kernel.org/pub/software/scm/git/git-2.54.0.tar.xz (SHA256 checksum: `f689162364c10de79ef89aa8dbf48731eb057e34edbbd20aca510ce0154681a3`)
...
* file: https://github.com/git-for-windows/git/releases/download/v2.54.0.windows.1/Git-2.54.0-64-bit.tar.bz2 (SHA256 checksum: `e1819cee60d09793dde322cdb1170e03663c41cd9265cf45246219fc5e6aeecd`)
