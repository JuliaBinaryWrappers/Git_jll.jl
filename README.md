# `Git_jll.jl` (v2.51.0+0)

[![deps](https://juliahub.com/docs/Git_jll/deps.svg)](https://juliahub.com/ui/Packages/General/Git_jll/)

This is an autogenerated package constructed using [`BinaryBuilder.jl`](https://github.com/JuliaPackaging/BinaryBuilder.jl).

The originating [`build_tarballs.jl`](https://github.com/JuliaPackaging/Yggdrasil/blob/bd7d6681fbe0dddc41cb4c9d4714c7283bd811ff/G/Git/build_tarballs.jl) script can be found on [`Yggdrasil`](https://github.com/JuliaPackaging/Yggdrasil/), the community build tree.
